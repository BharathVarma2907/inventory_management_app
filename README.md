...
git commit -m "feat: implement database schema for products and history"

# Backend Features
git commit -m "feat: add product CRUD operations"
git commit -m "feat: implement CSV import with duplicate detection"
git commit -m "feat: add CSV export functionality"
git commit -m "feat: implement inventory history tracking"
git commit -m "feat: add search and filter endpoints"

# Frontend Features
git commit -m "feat: setup React app with Vite and Tailwind CSS"
git commit -m "feat: create product table with inline editing"
git commit -m "feat: implement search and category filtering"
git commit -m "feat: add CSV import modal with drag-and-drop"
git commit -m "feat: create inventory history sidebar"
git commit -m "feat: add product creation modal"

# Improvements
git commit -m "style: improve UI with color-coded status badges"
git commit -m "feat: add toast notifications for user feedback"
git commit -m "refactor: optimize API calls with axios interceptors"
git commit -m "fix: resolve duplicate name validation issue"
...
git commit -m "chore: setup Docker containers for production"
```
